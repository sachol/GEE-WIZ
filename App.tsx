    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center space-y-8">
        <header className="w-full relative text-center">
            <div className="absolute top-0 left-0">
                <button 
                    ...
                    className="w-9 h-9 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-full flex items-center justify-center text-xl font-bungee shadow-md transition-transform duration-200 hover:scale-110"
                    aria-label={t('info')}
                >
                    ?
                </button>
          ...
          <h1 className="font-bungee text-5xl sm:text-6xl lg:text-7xl text-yellow-400" style={{ textShadow: '3px 3px 0px #ef4444' }}>
            {t('geeWiz')}
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 tracking-wider">{t('racingGameSensation')}</p>
        </header>
        ...
        <footer className="text-gray-500 text-center text-sm pt-4">
            <p>{t('footer')}</p>
            <p className="text-yellow-400">{t('distributor')}</p>
        </footer>
      </div>
      <InfoModal isOpen={isInfoModalOpen} onClose={() => setIsInfoModalOpen(false)} t={t as (key: string) => string} />
    </div>
  );
};
